...
describe("<Footer />", () => {
  ...
  it("renders contact icons: four jump to /home#contact, 知识星球 links to services coupon section", () => {
    render(<Footer />);
    expect(screen.getByRole("link", { name: "前往联系我 — 微信" })).toHaveAttribute("href", "/home#contact");
    expect(screen.getByRole("link", { name: "前往联系我 — GitHub" })).toHaveAttribute("href", "/home#contact");
    expect(screen.getByRole("link", { name: "前往联系我 — CSDN" })).toHaveAttribute("href", "/home#contact");
    expect(screen.getByRole("link", { name: "前往联系我 — 邮箱" })).toHaveAttribute("href", "/home#contact");
