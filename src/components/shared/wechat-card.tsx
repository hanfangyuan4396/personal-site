...
export function WechatCard() {
  return (
    <div className="flex w-full max-w-[680px] flex-col overflow-hidden rounded-2xl border border-border bg-card sm:flex-row sm:items-center">
      ...
      <div className="flex gap-4 px-4 pt-5 sm:contents sm:p-0">
        <div className="flex shrink-0 items-center justify-center sm:py-7 sm:pl-7 sm:pr-4">
          <Image
            ...
            width={120}
            height={120}
            className="h-20 w-20 rounded-full border-2 border-foreground/70 object-cover sm:h-[120px] sm:w-[120px] sm:border-[2.5px]"
          />
        </div>

        <div className="min-w-0 flex-1 sm:px-5 sm:py-6">
          <div className="mb-3 flex flex-wrap items-baseline gap-x-3 gap-y-1 border-b border-border pb-3 sm:gap-4">
